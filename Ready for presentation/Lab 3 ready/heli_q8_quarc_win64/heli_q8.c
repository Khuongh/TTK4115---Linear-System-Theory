 ...
 * C source code generated on : Tue Nov 15 18:49:23 2022
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    tmp_0[0] = 1.0;
    tmp_0[3] = a_z * a_y;
    tmp_0[6] = Sum3_tmp * a_y;
    tmp_0[1] = 0.0;
    tmp_0[4] = Sum3_tmp;
    tmp_0[7] = -a_z;
    tmp_0[2] = 0.0;
    tmp_0[5] = a_z / Sum3_tmp_0;
    tmp_0[8] = Sum3_tmp / Sum3_tmp_0;
    ...
    for (i = 0; i < 3; i++) {
       ...
       */
      heli_q8_B.Sum3[i] = (tmp_0[i + 6] * tmp_1[2] + (tmp_0[i + 3] * tmp_1[1] +
        tmp_0[i] * tmp_1[0])) + heli_q8_P.dev_rates_IMU[i];
    }
  ...
  for (i = 0; i < 2; i++) {
    a_y = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      a_y += heli_q8_P.K[(i_0 << 1) + i] * tmp[i_0];
    }
  ...
  for (i = 0; i < 5; i++) {
    ...
    tmp_3[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_3[i] += heli_q8_P.A_L[5 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }

    /* End of Gain: '<S8>/Gain' */

    /* Gain: '<S8>/Gain1' */
    tmp_2[i] = heli_q8_P.B_L[i + 5] * a_z + heli_q8_P.B_L[i] * a_y;
  }
  ...
  for (i = 0; i < 5; i++) {
    ...
    heli_q8_B.Sum1_c[i] = (tmp_2[i] + tmp_3[i]) + a_y;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3270816399U);
  heli_q8_M->Sizes.checksums[1] = (1531659863U);
  heli_q8_M->Sizes.checksums[2] = (4014111809U);
  heli_q8_M->Sizes.checksums[3] = (3716392498U);
