  ...
  ;%**************************
    ...
    ;%
	  ...
	  section.data(31).dtTransOffset = 99;
	
	  ;% heli_q8_B.FrontmotorSaturation
	  section.data(32).logicalSrcIdx = 31;
	  section.data(32).dtTransOffset = 101;
	
	  ;% heli_q8_B.BackmotorSaturation
	  section.data(33).logicalSrcIdx = 32;
	  section.data(33).dtTransOffset = 102;
	
	  ;% heli_q8_B.Memory3
	  section.data(34).logicalSrcIdx = 33;
	  section.data(34).dtTransOffset = 103;
	  ...
	  section.data(36).dtTransOffset = 175;
	  ...
	  section.data(38).dtTransOffset = 177;
	
	  ;% heli_q8_B.x_pri
	  section.data(39).logicalSrcIdx = 38;
	  section.data(39).dtTransOffset = 178;
	
	  ;% heli_q8_B.P_pri
	  section.data(40).logicalSrcIdx = 39;
	  section.data(40).dtTransOffset = 184;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 123;
	  ...
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 126;
  ...
  targMap.checksum0 = 709313473;
  targMap.checksum1 = 1629321298;
  targMap.checksum2 = 3953503975;
  targMap.checksum3 = 2272189837;
