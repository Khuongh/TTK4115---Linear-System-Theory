 ...
 * C source code generated on : Tue Nov 15 18:32:04 2022
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    rtb_Sum_k = heli_q8_P.Constant1_Value - heli_q8_B.Sum;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S5>/Sum'
     */
    rtb_DeadZoney = heli_q8_P.Gain_Gain * heli_q8_B.Joystick_gain_x -
      heli_q8_B.PitchCounttorad;

    /* Sum: '<Root>/Sum1' */
    heli_q8_B.Sum1 = rtb_DeadZoney;

    /* Gain: '<S5>/Gain' */
    heli_q8_B.Gain = rtb_DeadZoney * heli_q8_P.K_pp;
  }
   ...
   *  Gain: '<S5>/Gain1'
   */
  rtb_DeadZoney = heli_q8_B.Gain - heli_q8_P.K_pd * heli_q8_B.PitchTransferFcn;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S6>/K_ei' */
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum_m - rtb_DeadZoney) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum_m + rtb_DeadZoney) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2684467865U);
  heli_q8_M->Sizes.checksums[1] = (261154126U);
  heli_q8_M->Sizes.checksums[2] = (1182230315U);
  heli_q8_M->Sizes.checksums[3] = (1971455398U);
