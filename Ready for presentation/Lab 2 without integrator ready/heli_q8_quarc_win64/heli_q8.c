 ...
 * C source code generated on : Tue Nov 15 18:36:53 2022
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  for (i = 0; i < 2; i++) {
     ...
     *  Gain: '<S5>/Gain11'
     *  SignalConversion generated from: '<S5>/Gain11'
     */
    heli_q8_B.Sum6[i] = heli_q8_B.Gain10[i] - ((heli_q8_P.K[i + 2] *
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2775236731U);
  heli_q8_M->Sizes.checksums[1] = (687497449U);
  heli_q8_M->Sizes.checksums[2] = (1011864972U);
  heli_q8_M->Sizes.checksums[3] = (3480706995U);
