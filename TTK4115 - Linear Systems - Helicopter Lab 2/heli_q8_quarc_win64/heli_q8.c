 ...
 * C source code generated on : Tue Sep 27 19:41:53 2022
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.Gain10[0] += heli_q8_P.F[0] * rtb_Gain;
    heli_q8_B.Gain10[0] += heli_q8_P.F[2] * heli_q8_B.Gain1;
    heli_q8_B.Gain10[1] = 0.0;
    heli_q8_B.Gain10[1] += heli_q8_P.F[1] * rtb_Gain;
    heli_q8_B.Gain10[1] += heli_q8_P.F[3] * heli_q8_B.Gain1;
  ...
  for (i = 0; i < 2; i++) {
    ...
    heli_q8_B.Sum6[i] = heli_q8_B.Gain10[i] - u0;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<Root>/Sum1' */
    heli_q8_B.Sum1 = rtb_Gain - heli_q8_B.PitchCounttorad;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S5>/Sum7' */
    heli_q8_B.Sum7 = rtb_Gain - heli_q8_B.PitchCounttorad;
  }
            ...
            if (fp != (NULL)) {
              ...
              if (fwrite(u, sizeof(real_T), 1 + 1, fp) != 1 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file Lab_2_case_files\\Lab2_case_3.x.x.mat");
                return;
              }
              ...
              if (((++heli_q8_DW.ToFile_IWORK.Count) * (1 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              ...
                              "    allowed in MAT-file Lab_2_case_files\\Lab2_case_3.x.x.mat.\n");
              }
            }
          }
        }
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "Lab_2_case_files\\Lab2_case_3.x.x.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file Lab_2_case_files\\Lab2_case_3.x.x.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 1 + 1, 0, "data")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file Lab_2_case_files\\Lab2_case_3.x.x.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file Lab_2_case_files\\Lab2_case_3.x.x.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file Lab_2_case_files\\Lab2_case_3.x.x.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 1 + 1, heli_q8_DW.ToFile_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for data to MAT-file Lab_2_case_files\\Lab2_case_3.x.x.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2527625676U);
  heli_q8_M->Sizes.checksums[1] = (3595852201U);
  heli_q8_M->Sizes.checksums[2] = (4067363843U);
  heli_q8_M->Sizes.checksums[3] = (3149943911U);
  ...
  heli_q8_M->Sizes.numBlocks = (56);   /* Number of blocks */
