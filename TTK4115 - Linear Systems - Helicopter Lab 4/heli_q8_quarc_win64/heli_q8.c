...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<S5>/Gain1' */
    for (i = 0; i < 3; i++) {
      tmp_3[i] = heli_q8_P.Gain1_Gain[i + 6] * heli_q8_B.Switch[5] +
    ...
    for (i = 0; i < 3; i++) {
       ...
       */
      heli_q8_B.Sum3[i] = (tmp_2[i + 6] * tmp_3[2] + (tmp_2[i + 3] * tmp_3[1] +
        tmp_2[i] * tmp_3[0])) + heli_q8_P.dev_rates_IMU[i];
    }
          ...
          if (!(++heli_q8_DW.ToFile1_IWORK.Decimation % 1) &&
            ...
            if (fp != (NULL)) {
              ...
              if (fwrite(u, sizeof(real_T), 12 + 1, fp) != 12 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file Lab_3_case_files\\Lab_3_case_1.10.mat");
                return;
              }
              ...
              if (((++heli_q8_DW.ToFile1_IWORK.Count) * (12 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              ...
                              "    the simulation has ended, because it has reached\n"
                              "    the maximum number of elements (100000000)\n"
                              "    allowed in MAT-file Lab_3_case_files\\Lab_3_case_1.10.mat.\n");
              }
            }
          }
        }
  ...
  for (i = 0; i < 5; i++) {
    rtb_Sum[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Sum[i] += heli_q8_P.C_L[5 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }
  }
  ...
  /* Sum: '<S8>/Sum' */
  tmp[0] = heli_q8_B.Sum1[0] - rtb_Sum[0];
  tmp[1] = heli_q8_B.Sum3[0] - rtb_Sum[1];
  tmp[2] = heli_q8_B.Sum1[1] - rtb_Sum[2];
  tmp[3] = heli_q8_B.Sum3[1] - rtb_Sum[3];
  tmp[4] = heli_q8_B.Sum3[2] - rtb_Sum[4];
  ...
  for (i = 0; i < 5; i++) {
    ...
    tmp_5[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_5[i] += heli_q8_P.A_L[5 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }

    /* End of Gain: '<S8>/Gain' */

    /* Gain: '<S8>/Gain1' */
    tmp_4[i] = heli_q8_P.B_L[i + 5] * a_z + heli_q8_P.B_L[i] * a_y;
  }
  ...
  for (i = 0; i < 5; i++) {
    ...
    a_y = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      a_y += heli_q8_P.L[5 * i_0 + i] * rtb_Sum[i_0];
    }

    heli_q8_B.Sum1_c[i] = (tmp_4[i] + tmp_5[i]) + a_y;
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "Lab_3_case_files\\Lab_3_case_1.10.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file Lab_3_case_files\\Lab_3_case_1.10.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 12 + 1, 0, "data")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file Lab_3_case_files\\Lab_3_case_1.10.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file Lab_3_case_files\\Lab_3_case_1.10.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file Lab_3_case_files\\Lab_3_case_1.10.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 12 + 1, heli_q8_DW.ToFile1_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for data to MAT-file Lab_3_case_files\\Lab_3_case_1.10.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  rtmSetTFinal(heli_q8_M, 60.0);
  heli_q8_M->Timing.stepSize0 = 0.002;
  heli_q8_M->Timing.stepSize1 = 0.002;
  heli_q8_M->Timing.stepSize2 = 0.01;

  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (570426339U);
  heli_q8_M->Sizes.checksums[1] = (3270585581U);
  heli_q8_M->Sizes.checksums[2] = (2488248068U);
  heli_q8_M->Sizes.checksums[3] = (2348474271U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (555);/* Sum of parameter "widths" */
  return heli_q8_M;
}
