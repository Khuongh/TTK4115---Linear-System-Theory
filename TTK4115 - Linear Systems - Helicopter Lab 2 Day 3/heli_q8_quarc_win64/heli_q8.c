 ...
 * C source code generated on : Tue Nov 15 18:04:07 2022
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Gain = heli_q8_P.Gain_Gain * heli_q8_P.Constant1_Value;
  }
  ...
  if (u0 < heli_q8_P.Step_Time) {
    tmp_1 = heli_q8_P.Step_Y0;
  } else {
    tmp_1 = heli_q8_P.Step_YFinal;
  }

  /* End of Step: '<Root>/Step' */

  /* Step: '<Root>/Step2' */
  if (u0 < heli_q8_P.Step2_Time) {
    u0 = heli_q8_P.Step2_Y0;
  } else {
    u0 = heli_q8_P.Step2_YFinal;
  }

  /* Gain: '<Root>/Gain1' incorporates:
   *  Sum: '<Root>/Sum2'
   */
  heli_q8_B.Gain1 = (tmp_1 + u0) * heli_q8_P.Gain1_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  /* SignalConversion generated from: '<S5>/Gain11' incorporates:
  ...
  for (i = 0; i < 2; i++) {
    ...
    /* End of Gain: '<S5>/Gain11' */

    /* Sum: '<S5>/Sum6' incorporates:
     *  Gain: '<S5>/Gain10'
     *  SignalConversion generated from: '<S5>/Gain10'
     */
    heli_q8_B.Sum6[i] = (heli_q8_P.F[i + 2] * heli_q8_B.Gain1 + heli_q8_P.F[i] *
                         heli_q8_B.Gain) - tmp_0[i];
  }

  /* Sum: '<Root>/Sum' incorporates:
   *  Constant: '<Root>/Constant'
   */
  heli_q8_B.Sum = heli_q8_B.Sum6[0] + heli_q8_P.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<Root>/Sum1' */
    heli_q8_B.Sum1 = heli_q8_B.Gain - heli_q8_B.PitchCounttorad;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum_f = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value;
    ...
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.Sum_f;
            ...
            if (fp != (NULL)) {
              ...
              if (fwrite(u, sizeof(real_T), 8 + 1, fp) != 8 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file Lab_2_case_files\\Lab2_case_3.2.mat");
                return;
              }
              ...
              if (((++heli_q8_DW.ToFile_IWORK.Count) * (8 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              ...
                              "    allowed in MAT-file Lab_2_case_files\\Lab2_case_3.2.mat.\n");
              }
            }
          }
        }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum - heli_q8_B.Sum6[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum + heli_q8_B.Sum6[1]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S5>/Sum7' */
    heli_q8_B.Sum7 = heli_q8_B.Gain - heli_q8_B.PitchCounttorad;
  }

  /* Sum: '<S5>/Sum8' */
  heli_q8_B.Sum8 = heli_q8_B.Gain1 - heli_q8_B.ElevationTransferFcn;
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "Lab_2_case_files\\Lab2_case_3.2.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file Lab_2_case_files\\Lab2_case_3.2.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 8 + 1, 0, "data")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file Lab_2_case_files\\Lab2_case_3.2.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file Lab_2_case_files\\Lab2_case_3.2.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file Lab_2_case_files\\Lab2_case_3.2.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 8 + 1, heli_q8_DW.ToFile_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for data to MAT-file Lab_2_case_files\\Lab2_case_3.2.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (904562457U);
  heli_q8_M->Sizes.checksums[1] = (2916108075U);
  heli_q8_M->Sizes.checksums[2] = (2942285521U);
  heli_q8_M->Sizes.checksums[3] = (2064581922U);
...

  {
    ...
    heli_q8_B.ElevationTransferFcn = 0.0;
    heli_q8_B.Sum6[0] = 0.0;
    heli_q8_B.Sum6[1] = 0.0;
    heli_q8_B.Sum = 0.0;
    heli_q8_B.Sum1 = 0.0;
  ...
  heli_q8_M->Sizes.numBlockPrms = (167);/* Sum of parameter "widths" */
  return heli_q8_M;
}
