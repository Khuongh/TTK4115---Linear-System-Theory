...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  Step: '<Root>/Step2'
   */
  Sum1_tmp = heli_q8_M->Timing.t[0];
  if (Sum1_tmp < heli_q8_P.Step1_Time) {
  ...
  /* Gain: '<Root>/Gain' */
  heli_q8_B.Gain = heli_q8_P.Gain_Gain * u0;

  /* Step: '<Root>/Step' */
  if (Sum1_tmp < heli_q8_P.Step_Time) {
  ...
  /* Step: '<Root>/Step2' */
  if (Sum1_tmp < heli_q8_P.Step2_Time) {
    Sum1_tmp = heli_q8_P.Step2_Y0;
  } else {
    Sum1_tmp = heli_q8_P.Step2_YFinal;
  }

  /* Gain: '<Root>/Gain1' incorporates:
   *  Sum: '<Root>/Sum2'
   */
  heli_q8_B.Gain1 = (u0 + Sum1_tmp) * heli_q8_P.Gain1_Gain;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
   ...
   *  Sum: '<S5>/Sum7'
   */
  Sum1_tmp = heli_q8_B.Gain - heli_q8_B.PitchCounttorad;

  /* Sum: '<Root>/Sum1' */
  heli_q8_B.Sum1 = Sum1_tmp;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
            ...
            if (fp != (NULL)) {
              ...
              if (fwrite(u, sizeof(real_T), 8 + 1, fp) != 8 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file Lab_2_case_files\\Lab2_case_2.2.11.mat");
                return;
              }
              ...
              if (((++heli_q8_DW.ToFile_IWORK.Count) * (8 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              ...
                              "    allowed in MAT-file Lab_2_case_files\\Lab2_case_2.2.11.mat.\n");
              }
            }
          }
        }
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "Lab_2_case_files\\Lab2_case_2.2.11.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file Lab_2_case_files\\Lab2_case_2.2.11.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 8 + 1, 0, "data")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file Lab_2_case_files\\Lab2_case_2.2.11.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file Lab_2_case_files\\Lab2_case_2.2.11.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file Lab_2_case_files\\Lab2_case_2.2.11.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 8 + 1, heli_q8_DW.ToFile_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for data to MAT-file Lab_2_case_files\\Lab2_case_2.2.11.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  rtmSetTFinal(heli_q8_M, 70.0);
  heli_q8_M->Timing.stepSize0 = 0.002;
  heli_q8_M->Timing.stepSize1 = 0.002;
  heli_q8_M->Timing.stepSize2 = 0.01;

  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (406877316U);
  heli_q8_M->Sizes.checksums[1] = (1935283717U);
  heli_q8_M->Sizes.checksums[2] = (3373576371U);
  heli_q8_M->Sizes.checksums[3] = (1199425167U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (169);/* Sum of parameter "widths" */
  return heli_q8_M;
}
