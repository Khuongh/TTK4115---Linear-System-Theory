 ...
 * C source code generated on : Tue Nov 15 18:22:31 2022
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_TmpSignalConversionAtToFi_n[12];
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* MATLAB Function '[a_x, a_y, a_z]  to [pitch, elevation]': '<S10>:1' */
    /* '<S10>:1:3' */
    /* '<S10>:1:4' */
    ...
    /* Gain: '<S5>/Gain1' */
    for (i = 0; i < 3; i++) {
      rtb_Sum[i] = heli_q8_P.Gain1_Gain[i + 6] * heli_q8_B.Switch[5] +
    ...
    for (i = 0; i < 3; i++) {
       ...
       */
      heli_q8_B.Sum3[i] = (tmp_2[i + 6] * rtb_Sum[2] + (tmp_2[i + 3] * rtb_Sum[1]
        + tmp_2[i] * rtb_Sum[0])) + heli_q8_P.dev_rates_IMU[i];
    }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFi_n[1] = heli_q8_B.Integrator[0];
    rtb_TmpSignalConversionAtToFi_n[2] = heli_q8_B.PitchTransferFcn;
    rtb_TmpSignalConversionAtToFi_n[3] = heli_q8_B.Integrator[1];
    rtb_TmpSignalConversionAtToFi_n[4] = heli_q8_B.Sum;
    rtb_TmpSignalConversionAtToFi_n[5] = heli_q8_B.Integrator[2];
    rtb_TmpSignalConversionAtToFi_n[6] = heli_q8_B.ElevationTransferFcn;
    rtb_TmpSignalConversionAtToFi_n[7] = heli_q8_B.Integrator[3];
    rtb_TmpSignalConversionAtToFi_n[8] = heli_q8_B.TravelTransferFcn;
    rtb_TmpSignalConversionAtToFi_n[9] = heli_q8_B.Integrator[4];
    rtb_TmpSignalConversionAtToFi_n[10] = heli_q8_B.Gain;
    rtb_TmpSignalConversionAtToFi_n[11] = heli_q8_B.Gain1;
      ...
      if (rtmIsMajorTimeStep(heli_q8_M) ) {
        {
          if (!(++heli_q8_DW.ToFile1_IWORK.Decimation % 1) &&
              (heli_q8_DW.ToFile1_IWORK.Count * (12 + 1)) + 1 < 100000000 ) {
            ...
            if (fp != (NULL)) {
              ...
              if (fwrite(u, sizeof(real_T), 12 + 1, fp) != 12 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file Lab_3_case_files\\Lab_3_case_1.11.mat");
                return;
              }

              if (((++heli_q8_DW.ToFile1_IWORK.Count) * (12 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              "*** The ToFile block will stop logging data before\n"
                              "    the simulation has ended, because it has reached\n"
                              "    the maximum number of elements (100000000)\n"
                              "    allowed in MAT-file Lab_3_case_files\\Lab_3_case_1.11.mat.\n");
              }
            }
          }
        }
  ...
  tmp[3] = heli_q8_X.Integrator_CSTATE_m;
   ...
   */
  tmp_0[0] = heli_q8_P.F[0] * heli_q8_B.Gain + heli_q8_P.F[2] * heli_q8_B.Gain1;

  /* SignalConversion generated from: '<S7>/Gain11' */
  tmp[1] = heli_q8_B.Integrator[1];

  /* Gain: '<S7>/Gain10' incorporates:
   *  SignalConversion generated from: '<S7>/Gain10'
   */
  tmp_0[1] = heli_q8_P.F[1] * heli_q8_B.Gain;
  tmp_0[1] += heli_q8_P.F[3] * heli_q8_B.Gain1;
  for (i = 0; i < 2; i++) {
    /* Gain: '<S7>/Gain11' */
    tmp_1[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
  ...
  /* Sum: '<S7>/Sum7' */
  heli_q8_B.Sum7 = heli_q8_B.Gain - heli_q8_B.Integrator[0];

  /* Sum: '<S7>/Sum8' */
  heli_q8_B.Sum8 = heli_q8_B.Gain1 - heli_q8_B.Integrator[3];

  /* Gain: '<S8>/Gain2' */
  for (i = 0; i < 3; i++) {
    rtb_Sum[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Sum[i] += heli_q8_P.C_L[3 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }
  }
  ...
  /* Sum: '<S8>/Sum' */
  a_y = heli_q8_B.Sum1[0] - rtb_Sum[0];
  a_z = heli_q8_B.Sum1[1] - rtb_Sum[1];
  Sum3_tmp = heli_q8_B.Sum3[2] - rtb_Sum[2];

  /* SignalConversion generated from: '<S8>/Gain1' */
  Sum3_tmp_0 = rtb_Sum6[1];
  rtb_Sum6_idx_1 = rtb_Sum6[0];
  for (i = 0; i < 5; i++) {
    /* Gain: '<S8>/Gain' */
    tmp[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp[i] += heli_q8_P.A_L[5 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }
     ...
     *  Sum: '<S8>/Sum'
     */
    heli_q8_B.Sum1_c[i] = ((heli_q8_P.L[i + 5] * a_z + heli_q8_P.L[i] * a_y) +
      heli_q8_P.L[i + 10] * Sum3_tmp) + ((heli_q8_P.B_L[i + 5] * rtb_Sum6_idx_1
      + heli_q8_P.B_L[i] * Sum3_tmp_0) + tmp[i]);
  }
...
void heli_q8_derivatives(void)
{
  ...
  for (i = 0; i < 5; i++) {
    _rtXdot->Integrator_CSTATE[i] = heli_q8_B.Sum1_c[i];
  }
  ...
  _rtXdot->Integrator_CSTATE_m = heli_q8_B.Sum7;
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "Lab_3_case_files\\Lab_3_case_1.11.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file Lab_3_case_files\\Lab_3_case_1.11.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 12 + 1, 0, "data")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file Lab_3_case_files\\Lab_3_case_1.11.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file Lab_3_case_files\\Lab_3_case_1.11.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file Lab_3_case_files\\Lab_3_case_1.11.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 12 + 1, heli_q8_DW.ToFile1_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for data to MAT-file Lab_3_case_files\\Lab_3_case_1.11.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1148169018U);
  heli_q8_M->Sizes.checksums[1] = (724709050U);
  heli_q8_M->Sizes.checksums[2] = (2979908024U);
  heli_q8_M->Sizes.checksums[3] = (1544430260U);
  ...
  heli_q8_M->Sizes.numBlocks = (103);  /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (25);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (535);/* Sum of parameter "widths" */
  return heli_q8_M;
}
