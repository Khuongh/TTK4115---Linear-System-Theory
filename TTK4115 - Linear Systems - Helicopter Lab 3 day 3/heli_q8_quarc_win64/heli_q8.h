...
struct P_heli_q8_T_ {
  real_T A_L[25];                      /* Variable: A_L
                                        * Referenced by: '<S8>/Gain'
                                        */
  real_T B_L[10];                      /* Variable: B_L
                                        * Referenced by: '<S8>/Gain1'
                                        */
  real_T C_L[15];                      /* Variable: C_L
 ...
 * '<S6>'   : 'heli_q8/Joystick'
 * '<S7>'   : 'heli_q8/LQR'
 * '<S8>'   : 'heli_q8/Luenberger observer'
 * '<S9>'   : 'heli_q8/Pitch controller'
 * '<S10>'  : 'heli_q8/[a_x, a_y, a_z]  to [pitch, elevation]'
