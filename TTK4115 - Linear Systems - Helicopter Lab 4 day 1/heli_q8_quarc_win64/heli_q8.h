...
typedef struct {
  ...
  real_T Memory1[6];                   /* '<Root>/Memory1' */
  real_T Memory[36];                   /* '<Root>/Memory' */
  real_T Memory2[6];                   /* '<Root>/Memory2' */
  real_T Switch_a[6];                  /* '<Root>/Switch' */
  ...
  real_T Memory3[36];                  /* '<Root>/Memory3' */
  real_T Switch1[36];                  /* '<Root>/Switch1' */
  real_T Sum7_h;                       /* '<S9>/Sum7' */
  real_T Sum8_p;                       /* '<S9>/Sum8' */
  ...
  real_T x_pri[6];                     /* '<Root>/Kalman calculator' */
  real_T P_pri[36];                    /* '<Root>/Kalman calculator' */
...
typedef struct {
  ...
  real_T Memory_PreviousInput_b[36];   /* '<Root>/Memory' */
  real_T Memory2_PreviousInput[6];     /* '<Root>/Memory2' */
  real_T HILWriteAnalog_Buffer[2];     /* '<S4>/HIL Write Analog' */
  real_T Memory3_PreviousInput[36];    /* '<Root>/Memory3' */
  ...
  struct {
    void *LoggedData;
  } Elevesterr_PWORK;                  /* '<Root>/Elev. est. err' */

  struct {
    void *LoggedData;
  } Elevrateesterr_PWORK;              /* '<Root>/Elev. rate est. err' */

  struct {
    void *LoggedData[2];
  } Elevratevsest_PWORK;               /* '<Root>/Elev. rate vs est.' */

  struct {
    void *LoggedData[2];
  } Elevvsest_PWORK;                   /* '<Root>/Elev. vs est.' */
  ...
  struct {
    void *LoggedData;
  } Pitchesterr_PWORK;                 /* '<Root>/Pitch est. err' */
  ...
  struct {
    void *LoggedData;
  } Pitchrateesterr_PWORK;             /* '<Root>/Pitch rate est. err' */

  struct {
    void *LoggedData[2];
  } Pitchratevsest_PWORK;              /* '<Root>/Pitch rate vs est.' */

  struct {
    void *LoggedData[2];
  } Pitchvsest_PWORK;                  /* '<Root>/Pitch vs est.' */
  ...
  struct {
    void *LoggedData;
  } Travelesterr_PWORK;                /* '<Root>/Travel est. err' */
  ...
  struct {
    void *LoggedData;
  } Travelrateesterr_PWORK;            /* '<Root>/Travel rate est. err' */

  struct {
    void *LoggedData[2];
  } Travelratevsest_PWORK;             /* '<Root>/Travel rate vs est.' */

  struct {
    void *LoggedData[2];
  } Travelvsest_PWORK;                 /* '<Root>/Travel vs est.' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_m;          /* '<S9>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_m;       /* '<S9>/Integrator' */
...
struct P_heli_q8_T_ {
  ...
  real_T R_d[36];                      /* Variable: R_d
                                        ...
                                        */
  real_T SYSD_B[12];                   /* Variable: SYSD_B
                                        * Referenced by: '<Root>/Kalman calculator'
                                        */
  real_T SYSD_C[36];                   /* Variable: SYSD_C
                                        * Referenced by: '<Root>/Kalman estimator'
                                        */
  real_T V_s0;                         /* Variable: V_s0
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T dev_rates_IMU[3];             /* Variable: dev_rates_IMU
                                        * Referenced by: '<Root>/Deviations rates'
                                        */
  real_T dev_states_IMU[2];            /* Variable: dev_states_IMU
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Constant_Value_f;             /* Expression: .53
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T Memory2_InitialCondition[6];  /* Expression: [0 0 0 0 0 0]
  ...
  real_T Step1_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T Step1_YFinal;                 /* Expression: -1/4
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T Step3_Time;                   /* Expression: 25
                                        * Referenced by: '<Root>/Step3'
                                        */
  real_T Step3_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step3'
                                        */
  real_T Step3_YFinal;                 /* Expression: 1/4
                                        * Referenced by: '<Root>/Step3'
                                        */
  real_T Gain_Gain;                    /* Expression: pi/2
  ...
  real_T Step_YFinal;                  /* Expression: 0.3
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step2_Time;                   /* Expression: 15
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: -.3
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Gain1_Gain_h;                 /* Expression: pi/2
  ...
  real_T BackmotorSaturation_LowerSat; /* Expression: -5
                                        * Referenced by: '<S4>/Back motor: Saturation'
                                        */
  real_T Memory3_InitialCondition[36];
 ...
 * '<S5>'   : 'heli_q8/IMU'
 * '<S6>'   : 'heli_q8/Joystick'
 * '<S7>'   : 'heli_q8/Kalman calculator'
 * '<S8>'   : 'heli_q8/Kalman estimator'
 * '<S9>'   : 'heli_q8/LQR'
 * '<S10>'  : 'heli_q8/Pitch controller'
 * '<S11>'  : 'heli_q8/[a_x, a_y, a_z]  to [pitch, elevation]'
